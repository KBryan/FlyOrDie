...
class GameScene: SKScene , SKPhysicsContactDelegate{
    ...
    override func didMoveToView(view: SKView) {
        ...
        */
        ...
        bird.physicsBody?.categoryBitMask = PhysicsCategory.birdGroup
        bird.physicsBody?.contactTestBitMask = PhysicsCategory.objectGroup
        bird.physicsBody?.collisionBitMask = PhysicsCategory.gapGroup
        self.addChild(bird)
    ...
    func makePipes() {
        ...
        let gapHeight = bird.size.height * 2.5
